...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Full Stack Developer specializing in ERP, CRM and enterprise applications with React, ASP.NET Core and SQL Server." },
      { name: "author", content: "Harish Kumar A" },
      ...
      { name: "twitter:title", content: "Harish Kumar A — Full Stack Developer" },
    ],
    links: [
      {
        rel: "stylesheet",
